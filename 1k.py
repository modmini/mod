...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[Ҩఖণಖஇ↭ধัюӄՁ่গს] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"[Ҩఖণಖஇ↭ধัюӄՁ่গს]\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
...
#-------------------------------------------------
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                msg.contentMetadata = {'mid': 'uda9c0018c241d3062c1c8a1dcc55769c'}
                cl.sendMessage(msg)                                                                                
                cl.sendText(msg.to, "Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")                                                 
