...
cl = LINETCR.LINE()
cl.login(token="EpzFYAW6otfqpbNRZ73c.kshcZIq57WGFdmhkBrR9Ra.gTIyNpbofOs0hJ27bO02+KvERDsXfU/NXchW+dxTuuE=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EpZ3UXZpZ64HS7EKTUt8.amYSOX9zGhB+F6AwRjNhAa.Fn0GfzSHbCn44ou1qh5GwZiSXZfC7UkJcSJMqqw4Sc8=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EpqSlTIQxCCbRG0QSrD4.K0dez3JsoPGfBG1Yv/mp9a.rnq/euPS6cw/TacsxIMFTj7Q+ccDfZJs2wF4cJkElVU=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EpzFYAW6otfqpbNRZ73c.kshcZIq57WGFdmhkBrR9Ra.gTIyNpbofOs0hJ27bO02+KvERDsXfU/NXchW+dxTuuE=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EpIyuIkarTHr9Gyguyb0.UwtBapdbDPximS8OcZv04a.W8DHX4RHqyEpRXZcpP/j8xzqGRQjwfWNZVd5XHiEHDw=")
ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="EpzFYAW6otfqpbNRZ73c.kshcZIq57WGFdmhkBrR9Ra.gTIyNpbofOs0hJ27bO02+KvERDsXfU/NXchW+dxTuuE=")
#ki5.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["uc64fa94a1acc0bfd5c2bb98d69a7417a",mid,Amid1,Amid2,Amid3,Amid4]
self = ["uc64fa94a1acc0bfd5c2bb98d69a7417a",mid,Amid1,Amid2,Amid3,Amid4]
admin = "uc64fa94a1acc0bfd5c2bb98d69a7417a"
admsa = "uc64fa94a1acc0bfd5c2bb98d69a7417a"
owner = "uc64fa94a1acc0bfd5c2bb98d69a7417a"
adminMID = "uc64fa94a1acc0bfd5c2bb98d69a7417a"
Creator="uc64fa94a1acc0bfd5c2bb98d69a7417a"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁[™టの∩™ゆণও௰้ণ🔝ধণπູಶ່ๅ ] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"[™టの∩™ゆণও௰้ণ🔝ধণπູಶ່ๅ ]\n\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดเถอะ","Phet all on"]:
                        cl.sendText(msg.to,"[™టの∩™ゆণও௰้ণ🔝ধণπູಶ່ๅ ]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ปิดเถอะ","Phet all off"]:
                        cl.sendText(msg.to,"™టの∩™ゆণও௰้ণ🔝ধণπູಶ່ๅ")
                        cl.sendText(msg.to,"Please wait......")
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in ["เจน","พี่เจน"]:
                        cl.sendText(msg.to,"รู้แล้วๆอย่าเรียกเยอะ")
