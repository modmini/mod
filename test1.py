...
cl = LINETCR.LINE()
cl.login(token="EpYgKvujVfEo8aHJwH23.2NgwL6jkJZ728bEP4WJn0W.tVzseFn8MMAw/D3z9h5lcGvoVkg/yS10HtHKRg7TXXI=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EpXv7LDZcBhQtkXDTg10.FRNuPDH+IflQ1xMY+ba/8a.v9FXlMKTrlaIlP539Pm0Js0D2sthvL61gywzj537hXY=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Ep74FpfJoXErz5sGyo67.W8s4FQJKmZIDap2LPJLinW.0X+YMRh6m6daSbHg5jalsqsC13kC2ra7LsKsKa9wOrc=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EpSRsPf9fFg33Myfij32.RAf8E6wKSi5Q3sBSm6jwaG.jkUlL976Ql94/HjatOEI0TnCSrkwGpyWrsWkih+Rw7Y=")
ki3.loginResult()
...
ki5 = LINETCR.LINE()
ki5.login(token="EpnfHnU9wG04EfaREEo6.r57tFXzJizSSQhvAaopu5G.li25QsmeV9T7zzW9u+mf5dZyKhZdrbcgkONAHrFegj0=")
ki5.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["uda719697a24a8f3ef6f017a9e308cdd3",mid,Amid1,Amid2,Amif3,Amid4,Amid5]
self = ["uda719697a24a8f3ef6f017a9e308cdd3",mid,Amid1,Amid2,Amif3,Amid4,Amid5]
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by.〖Ťäň〗-BΘ†ᴸᴵᶰᵉ",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["แท๊กทำใมเพื่อนเล่นหรา\nไม่สนิตอย่าติดว้าว\nอ่านทำใมเลื่อนผ่านไป\nถ้าสำคัญส่วนตัวเลย\n[〖Ťäň〗-BΘ†ᴸᴵᶰᵉThailand]"]
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'uda719697a24a8f3ef6f017a9e308cdd3'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/nootanzaa40")


            elif msg.text in ["ติก","Gift"]:
                msg.contentType = 9
...
#==================================================
            ...
            elif "สาว:" in msg.text:
                string = msg.text.replace("#หำ1:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
            elif msg.text in ["สาวมา","#Kicker","#kicker","Kicker","kicker","•••"]:
                        ...
                        ki1.sendText(msg.to,"[SELF BOT  TAN]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[TëàМ✈Šþёёđ✈Ðè|ё†ё.CluB]")
...
#==================================================
            ...
            elif "Tan key" in msg.text:
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{Tan HACK BOT}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n""")
...
#เทส
                                ...
                                bctxt = msg.text.replace("Tan Say ","")
...
#===============================================
                ...
                ki.sendText(msg.to, "[SELFBOT Tan HACK BOT]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.แทนไง ไครละคัฟ]")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"[SELFBO Tan HACK BOT]\n\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
...
#-------------------------------------------------
                        ...
                        cl.sendText(msg.to,"─┅══ईहざ.ざʆҩี้ઈʆʆמʨईह══┅─\n\n[SELF BOT Tan HACK BOT]")
                        cl.sendText(msg.to,"Please wait..........
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "[SELFBOT TAN HACK BOT]\n\n[ทีมยกบอท ลบนรก]\n[By.ทีมงานยกบอท]")
                cl.sendText(msg.to, "ผู้จัดการทีมงาน:ทีมงานยกบอท")
                msg.contentMetadata = {'mid': 'ua7872842a3becc26d000977982bba44b'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองผู้จัดการทีมงาน:ยกบอท")
                msg.contentMetadata = {'mid': 'u3e684fb7a128216b104104a1a8085fcd'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธานทีมงาน:ยกบอท")
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ร.ปธทีมงาน:ยกบอท")
                msg.contentMetadata = {'mid': 'u92cdea65389a2f8e833c80ac0752c004'}
                cl.sendMessage(msg)
...
#==============================================================================#
            ...
            elif msg.text in ["Blocklist","บ้อก","Pbann"]: 
                blockedlist = cl.getBlockedContactIds()
                kontak = cl.getContacts(blockedlist)
                num=1
                msgs="═════════List Blocked═════════"
