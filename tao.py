...
cl = LINETCR.LINE()
cl.login(token="Ep7R7B2WlrOpDvJ7yU78.Nd5vN/4JQ8lYPcdtr37xQa./YXfUO2DdQZtqX45rpY0bPABdzsBY806VeRh6TH3aB4=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EpYfttp7jFUv1nAn4o77.olQAft8sXSmPJaERc+f85W.lcPRNRZ95WU5pd2m582BWYMHuIezgDxRljroM2GYaxI=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EpXl1J1nTdzASqsglyV4.n9evoAxAv2h4jnN4QgrHTa.tIb6T6nUCvrjB15cxrJn5PKHLEzwZTp9gq05am1STDs=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EpVrHFuEjtsC5SdkmmFe.ESBsNdg2ohlxV6MDlLq1+G.HTr5WhI6cjMrLVsV8aGOilmUgdY70upJTzzw96LWS7s=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EpH1Cd8SU19p3i6HlCAe.ZtSDZThKJGh+sVT1Q0XGpG.XYaMaXXJuSariTjI7h0PtRhEgEKs0lop+QLc7zceJS8=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EphS6xR8DunLPHpHtrT9.yPcsLWph3BZHiNr1uQMicq.fbCbIQw0A19foUmYWa/c3gxmDgNxn9mENHzFtDScCCk=")
ki5.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u9c3e559fee23abc2f2a420d3477ed7a8",mid]
self = ["u9c3e559fee23abc2f2a420d3477ed7a8",mid]
admin = "u9c3e559fee23abc2f2a420d3477ed7a8"
admsa = "u9c3e559fee23abc2f2a420d3477ed7a8"
owner = "u9c3e559fee23abc2f2a420d3477ed7a8"
adminMID = "u9c3e559fee23abc2f2a420d3477ed7a8"
Creator="u9c3e559fee23abc2f2a420d3477ed7a8"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"แอดมารักหรือแอดมารัน\nBY.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ",
    "lang":"JP",
    "comment":"AutoLike by ✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["แท็กทำไมมีอะไร\nไม่สนิตมึงอย่าแท็กบ่อย\nถ้าว่างเดี่ยวมาตอบ..😊😊\nถ้าด่วนก็ส่วนตัว\n✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ"]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["แท็กทำไมไม่อ่านหรือไง..👆👆",cName + ""]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["แท็กอยู่ได้ไม่อ่านหรือไง..👆",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","-_-","Alin lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'u9c3e559fee23abc2f2a420d3477ed7a8'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯ http://line.me/ti/p~xcool.py")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki1.sendText(msg.to,"Hello " + str(ginfo.name) + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki1.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki1.leaveGroup(msg.to)
                        ki2.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki2.leaveGroup(msg.to)
                        ki3.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki3.leaveGroup(msg.to)
                        ki4.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki4.leaveGroup(msg.to)
                        ki5.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki5.leaveGroup(msg.to)
                        ki6.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki6.leaveGroup(msg.to)
                        ki7.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki7.leaveGroup(msg.to)
                        ki8.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki8.leaveGroup(msg.to)
                        ki9.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki9.leaveGroup(msg.to)
                        ki10.sendText(msg.to,"เขาไล่แล้ว จะอยู่ทำไม..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                ...
                cl.sendText(msg.to,"""[✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]\n\n
✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯
คำสั่งบอท siri
...
#เทส
                ...
                if wait["contact"] == True:
                    ...
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudan on Bosqu")
                    else:
                        cl.sendText(msg.to,"OK Bosqu")
...
#========================================
                ...
                md = "✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯\n\n"
...
#------------------------------------------------
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       ...
                       pass
#-----------------------------------------------
            elif msg.text in ["Backup:on","Backup on","เปิดการเชิญกลับ","เปิดดึงกลับ"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Backup:off","Backup off","ปิดการเชิญกลับ","ปิดดึงกลับ"]:
...
#========================================
            ...
            elif msg.text in ["Com on","Comment:on","เปิดเม้น"]:
                if wait["commentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Com off","Comment:off","ปิดเม้น"]:
            ...
            elif msg.text in ["Hhx1 on","เปิด1"]:
                if wait["acommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Hhx2 on","เปิด2"]:
                if wait["bcommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Hhx3 on","เปิด3"]:
            ...
            elif msg.text in ["Hhx1 off","ปิด1"]:
                if wait["acommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off")
            elif msg.text in ["Hhx2 off","ปิด2"]:
                if wait["bcommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off")
            elif msg.text in ["Hhx3 off","ปิด3"]:
...
#===============================================
                ...
                cl.sendText(msg.to, "เช็คสปีดกันหน่อย....👍")
                start = time.time()
                time.sleep(0.001)
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))    
                print "[Command]Speed palsu executed"
            elif msg.text in ["Bot Speed","Speedbot"]:
                ki1.sendText(msg.to, "เช็คความเร็วบอท....👍👍")
                start = time.time()
                time.sleep(0.001)
                elapsed_time = time.time() - start
                ...
                ki.sendText(msg.to, "[✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
...
#-----------------------------------------------
            elif msg.text in ["Url","url","ขอลิ้ง"]:
                if msg.toType == 2:
                    x = cl.getGroup(msg.to)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดทั้งหมด","เปิดหมด"]:
                        cl.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯\n\n[เต๋าลองทำบอท]")
            ...
            elif msg.text in ["ปิดทั้งหมด","ปิดหมด"]:
                        cl.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯\n\n[เต๋าลองทำบอท]")
                        cl.sendText(msg.to,"รอสักครู่......")
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "   [เต๋าลองทำบอท]\n\n[✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]\n.    [By.ทีมลองทำบอท]")
                cl.sendText(msg.to, "ประธานใหญ่:✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                msg.contentMetadata = {'mid': 'u9c3e559fee23abc2f2a420d3477ed7a8'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ஆ๊ণℓन ചচ൮✬ŪЮط௭ี่ধՁ✬")
                msg.contentMetadata = {'mid': 'u40f28986f8cfcc5a4abe926e5766aa20'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองประธาน:↭ゆஆ∫ღ💋ചচ.✬ŪЮط௭ี่ধՁ✬↭")
                msg.contentMetadata = {'mid': 'ud598f02196bbce56db90bdbb6c30b64c'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ผู้จัดการทีมงาน:YoSu ☞ṩтŏяγ☜")
                msg.contentMetadata = {'mid': 'ubb158feb97bb17c1f6ec9d823253e49a'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองผู้จัดการทีมงาน:❣™Ҩণ൮௮ໂҨຮี☞ṩтŏяγ☜")
                msg.contentMetadata = {'mid': 'uf0c42a718214406af23183530d9eea63'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รปภ.:∫ຟゆ↭နചচ.✬ŪЮط௭ี่ধՁ✬")
                msg.contentMetadata = {'mid': 'u3526fe03b07e8f96b5c0cfaf67b6b25e'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก:Aяıи☜နചচ✬ŪЮط௭ี่ধՁ✬")
                msg.contentMetadata = {'mid': 'ud41faa8cafc2b6dfc666f1ea368ca8e3'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก:➴-;ພี่ιສืටเਰさเମ♤ ☞ṩтŏяγ①☜")
                msg.contentMetadata = {'mid': 'u88002497040ca1a10d5549e8cc98c707'}
                cl.sendMessage(msg)
