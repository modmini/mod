...
cl = LINETCR.LINE()
cl.login(token="Epafg4K7Z7iSE2yZ6rQ1.YFM8IDnq32Z6Mr/QmB7Qyq.cH5iJ2MuFxMJoQKlISM0Y+tcTWxGRoYkpxK9UYFdJ8E=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="Epot6yM8jaibrWFC8L99.50YjM+UrXiPetp0eGMtqUq.AWPW0+HcyGO4WGmHZDHGvmVuEN76Ay2rYgJ6zN4d5jo=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EpiwXkM89Q6EgArWb0J3.7iDquI6OQTbFtNz3zX348W.62a859TTes+kg0UpfMPeIRNcvNOmHkaJJ3MBS4oTk7E=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EpcSvRhx4nk2RpndBJB1.odlcvX9XR1yZ1cMdF5640q.2PJo1LsChq70Q90oz3AD7qpXE1JUE/IUyX81VyWgWbo=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EpzRo7r66ZHlRz13I1O9.f3X/WKb9CX2NbamHwulzoq.GPx+jTYtOocFqPeUMeIbEMhBX3xfQKWhPE/ExrrzBqc=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EpSeh5Prsr0vNyOGoqRb.icGlqgnIpNfbDGxXnJIo2W.tI6xWJmOJ/IliPEYdTUOUY/rU22xSKkFpCvTE2MPlb8=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EpzH0nSoI4exo80cbbAd./dps7fw8tvL51v2bxrjrVq.p9oZe9KBjmPQUdxctZYq2sYmJfli+tECXhP8tFARQw0=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="Ep5Ztfg8lXwq7FE15791.J7MeDVfxh0WrhwfLd0Rmyq.ZfGwjXYuINakIlAscB0V3SZtIcFYEJdjSY/Y2lRgTvE=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EpLtMVYq4KGHfCisNuB5.jsjoyG3PJg+Pm3kJ60ZJTq.xKIYEqGpwgQjquhvEdBEpi+rE+SAYVh3d5YdgLO5nkk=")
ki8.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["uc9f9bc89d350df6cfa991faa31beea61",mid,Amid1,Amid2,Amid3,Amid4,Amid5,Amid6,Amid7,Amid8]
self = ["uc9f9bc89d350df6cfa991faa31beea61",mid,Amid1,Amid2,Amid3,Amid4,Amid5,Amid6,Amid7,Amid8]
admin = "uc9f9bc89d350df6cfa991faa31beea61"
admsa = "uc9f9bc89d350df6cfa991faa31beea61"
owner = "uc9f9bc89d350df6cfa991faa31beea61"
adminMID = "ubbdeded66fe5b86cca37d6b54e95019d"
Creator="ubbdeded66fe5b86cca37d6b54e95019d"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#===========================================
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                ...
                if msg.from_ == mid:
                    if "join:" in msg.text:
                        list_ = msg.text.split("uc9f9bc89d350df6cfa991faa31beea61")
                        try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["แท๊กทำเหี้ยไรเพื่อนเล่นมึงหรา\nไม่สนิตอย่าติดว้าว\nไม่สำคัญอย่าแท๊ก\nถ้าสำคัญส่วนตัวเลย\n[ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ]"]
...
#----------------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        pass
            elif msg.text.lower() in ["admins","ตัวแทน"]:
                msg.contentType = 13
                adm = 'uc9f9bc89d350df6cfa991faa31beea61'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/~0614781781")
...
#==================================================
            ...
            elif msg.text in ["เด็กๆ","#Kicker","#kicker","Kicker","kicker","•••"]:
                ...
                cl.sendText(msg.to,"""[ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ]\n\n
Phet Tema Hack Bot
คำสั่งบอท siri
...
#-------------------------------------------------
            ...
            elif msg.text in ["Phet All off","ปิดหมด"]:
                        cl.sendText(msg.to,"─┅══ईह ㏒ Märk ㏒ ईह══┅─\n\n[ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ทีมงาน""ทีมทดลองบอท""]:                msg.contentType = 13
                cl.sendText(msg.to, "\n[🔥ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ🔥]")
                cl.sendText(msg.to, "อาจารใหญ่:☬ധู้さန້ণق↔ധഖาໄฟ☬ ")
                msg.contentMetadata = {'mid': 'u6c8aab6ee167a596be2cf045ee2f90df'}                                    
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ผู้จัดการทีมงาน:〖ಟู้さန้ণঐ〗™ສণधஞপਙ์ი➣ ")
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                cl.sendMessage(msg)                                                                                   
                cl.sendText(msg.to, "รองผู้จัดการทีมงาน:🔯ℳάℛ₭🔯🔝ধণπູಶ່ๅ™")
                msg.contentMetadata = {'mid': 'uc9f9bc89d350df6cfa991faa31beea61'}                                   
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธานใหญ่:มินทีมทดลองบอท")
                msg.contentMetadata = {'mid': 'ua1cb6e845fe8f2646fe8a5c5911841fa'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:™టの∩™่ゆণও௰้ণ🔝ধণπູಶ່ๅ")
                msg.contentMetadata = {'mid': 'uc64fa94a1acc0bfd5c2bb98d69a7417a'}                                  
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รองประธาน:༄ऌ􂜁􀄔�􂜁􀄉�􂜁􀄇�􂜁􀄅�􂜁􀄒�ऌ࿐")
                msg.contentMetadata = {'mid': 'u7988143c47d3faacf1856a72011eea93'}                 
                cl.sendMessage(msg)
                cl.sendText(msg.to, "หน่วยทดลอง:─┅͜͡❂⃢ ž ⃢εη⃢‮─┅͜͡❂ ")
                msg.contentMetadata = {'mid': 'u999427ee98d55e99e9634eb7fb3358f9'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ผู้ดูแล:┈┅═ই͜͜͡❂ನีℓӄีधՁই═┅┈")                                                          
                msg.contentMetadata = {'mid': 'u9c3e559fee23abc2f2a420d3477ed7a8'}                                  
                cl.sendMessage(msg)
                cl.sendText(msg.to, "รปภ.:คนไร้ตัวตน")
                msg.contentMetadata = {'mid': 'u51a5f805ae23b5337c4cb8f82d269026'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก:➣ යู้ざ้ਙণঐ✯StarSta p")
                msg.contentMetadata = {'mid': 'u15b3c8c64c2fd733bea6f2718a52a861'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก:🍁⭐थํ้ণҨʨึ่७⭐🍁")                                                   
                msg.contentMetadata = {'mid': 'u948d78fb7aa66a211fcf4c6517dc1cfb'}                                   
                cl.sendMessage(msg)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               cl.sendText(msg.to, "ยืมไปม่อแปปนะ")
                            except Exception as e:
                                print e
            elif msg.text in ["เสดละ"]:
                try:
                    cl.updateDisplayPicture(backup.pictureStatus)
                    cl.updateProfile(backup)
                    cl.sendText(msg.to, "ขี้เกรียจม่อละเอาคือไป")
                except Exception as e:
                    cl.sendText(msg.to, str(e))
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in ["มาร์ค","มาค","มาก"]:
                        cl.sendText(msg.to,"อารายอีกบ่ว่างคุยกับสาวยุ")
