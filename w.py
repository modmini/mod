...
cl = LINETCR.LINE()
cl.login(token="EpcgDEWDvIxEj2fiv9M6.uAx4bA4JTtn8tlJ4lsAqjG./qgKpoQRjJjt78ck/Iw4IPxH6uX4n0tjJj4i/Pmo1Mc=")
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token="Ep018CV3N3fGI5BdZbf7.Sb/eA6DyxK19lE1pICW4TW.OutfLSiqmcOxdJO/G10/oxF1lkfMubEpXpgGL6p+uvo=")
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="EpTkxPUY0R7NiMJJqpe4.n0+lj1rm14og2hgk/QHIba.nX9vVX1UzZQSQZpA+Q7oaj+M7/dnppCc6Rbtb0GIgWo=")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="EpXRbs1oK4e61V1biD15.nJO06z6diNfjA3tMtlPBLq.HglIa4BUYhqh1YjnkakM1HpS4zA4WW6oh42vIX2In/w=")
#ki3.loginResult()
...
#ki9 = LINETCR.LINE()
#ki9.login(token="EoluRsFVIBC6WfNeGja.XeTFQ55WYwSmXh4n0wOhcG.Zl36VJU8INIcSFmmXsMSXyUZW+gbjmQTgE6LxBQpCa4=")
#ki9.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u51a5f805ae23b5337c4cb8f82d269026",mid]
self = ["u51a5f805ae23b5337c4cb8f82d269026",mid]
admin = "u51a5f805ae23b5337c4cb8f82d269026"
admsa = "u51a5f805ae23b5337c4cb8f82d269026"
owner = "u51a5f805ae23b5337c4cb8f82d269026"
adminMID = "u51a5f805ae23b5337c4cb8f82d269026"
Creator="u51a5f805ae23b5337c4cb8f82d269026"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#==================================================
            ...
            elif "Help3" in msg.text:
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
...
#-------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวป่วน:༺•㏒°ℓຫຼี้छπี้°㏒•༻")
                msg.contentMetadata = {'mid': 'u39b98d8a2032c9bb289f583811a2b941'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "หน่วยทดลอง:─┅͜͡❂⃢ ž ⃢εη⃢‮─┅͜͡❂ ")                                                                                                                             msg.contentMetadata = {'mid': 'u999427ee98d55e99e9634eb7fb3358f9'}
                cl.sendMessage(msg)
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวเเทนสมาชิก:➣ යู้ざ้ਙণঐ✯StarStamp")
